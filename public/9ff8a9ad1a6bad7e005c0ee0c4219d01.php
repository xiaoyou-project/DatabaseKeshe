<?php /*a:1:{s:23:"../view/punish-add.html";i:1577173265;}*/ ?>
<!DOCTYPE html>
        ...
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select id="change" name="change" lay-verify="change">
                            ...
                            <option value="<?php echo htmlentities($c['CODE']); ?>"><?php echo htmlentities($c['DESCRIPTION']); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input name="enable" id="enable" lay-verify="enable" type="checkbox"  lay-skin="switch">
                    </div>
                </div>
                <div class="layui-form-item">
