<?php /*a:1:{s:18:"../view/index.html";i:1577412802;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
    ...
    <body class="index mybg6">
        <!-- 顶部开始 -->
        <div class="container">
            <div class="logo">
                <a href="./index.html">学生信息管理系统</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    <a href="javascript:;"><?php echo htmlentities($name); ?></a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('数据可视化','tonji')">
                                    <i class="layui-icon">&#xe62c;</i>
                                    <cite>数据可视化</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('学生信息管理','member-list')">
                                    <i class="layui-icon">&#xe770;</i>
                                    <cite>学生信息管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('学籍变动管理','chang-list',true)">
                                    <i class="layui-icon">&#xe60e;</i>
                                    <cite>学籍变动管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('奖励记录管理','reward-list')">
                                    <i class="layui-icon">&#xe6c6;</i>
                                    <cite>奖励记录管理</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('处罚记录管理','punish-list')">
                                    <i class="layui-icon">&#xe6c5;</i>
                                    <cite>处罚记录管理</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('用户管理','admin-list')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户管理</cite></a>
                            </li>
                        </ul>
