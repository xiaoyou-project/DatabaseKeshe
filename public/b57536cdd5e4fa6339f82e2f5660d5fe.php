<?php /*a:1:{s:23:"../view/chang-list.html";i:1577263523;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                    ...
                    <form class="layui-form">
                        <div class="layui-input-inline">
                            <select lay-verify="choose" name="optioin">
                                ...
                                <option value="change">学籍变更</option>
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加记录','chang-add',430,480)"><i class="layui-icon"></i>添加记录</button>
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a title="编辑"  onclick="xadmin.open('编辑','chang-edit?id=<?php echo htmlentities($key['ID']); ?>',430,550);" href="javascript:;">
                    ...
                    <div class="page">
                        <div>
                            <form class="layui-form">
                                ...
                                <?php if($id>0): ?>
                                <a class="prev" href="chang-list?id=<?php echo htmlentities($id-1); ?>">上一页</a>
                                <?php endif; 
                                if($page>7){
                                for($i=($id-3);$i<=$id;$i++){
                                if($i>=1){
                                ...
                                echo '<a class="num" href="chang-list?id='.($i-1).'">'.$i.'</a>';
                                }
                                }
                                for($i=($id+1);$i<=($id+5);$i++){
                                if($i<=$page){
                                ...
                                echo '<a class="num" href="chang-list?id='.($i-1).'">'.$i.'</a>';
                                 ...
                                 if(($id+1)!=$page): ?>
                                <a class="next" href="chang-list?id=<?php echo htmlentities($id+1); ?>">下一页</a>
                                <?php endif; ?>
                                <div class="layui-inline layui-show-xs-block">
        ...
        function() {
            ...
            form.on('submit(sreach)',
                function(data) {
                    ...
                    window.location.href="chang-list?choose="+data.field.optioin+"&message="+data.field.message;
                    return false;
                });
            //跳转页面
            form.on('submit(goto)',
                function(data) {
                    window.location.href="chang-list?id="+(data.field.message-1);
                    return false;
                });
        });
    ...
    function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？',function(index){
            ...
            del=$.ajax({
                type: 'post',
                url:'/tools/changmdel',
                data:{ids:ids.toString(),type:'change'},
                success:function (msg) {
